...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            html = html + '<td class="action-btn"><a href="' + route1 + '"><i class="fa fa-edit"></i></a><a id="' + val.id + '" name="promo_delete_btn" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
