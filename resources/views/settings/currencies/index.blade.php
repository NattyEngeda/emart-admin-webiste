                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link do_not_create" href="{!! route('currencies.create') !!}"><i
...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            html = html + '<td class="action-btn"><a href="' + route1 + '" class="do_not_edit"><i class="fa fa-edit"></i></a><a id="' + val.id + '" name="currency-delete" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
