...
<style type="text/css">
	...
	.login-register{background-color:#0085FE;}
...
<div class="login-register">
 ...
 <div class="login-logo text-center py-3">
           ...
           <a href="#" style="display: inline-block;background: #fff;padding: 10px;border-radius: 5px;"><img style="width: 150px" src="{{ asset('images/logo_new.jpg') }}"> </a>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        {{ __('Login') }}
                                         ...
                                         <div class="form-group default-admin">
                                            <div class="crediantials-field">{{trans('lang.email')}}:<span id="email_field">admin@emart.com</span><a href="javascript:void(0)" onclick="copyToClipboard('admin@emart.com')"><i class="fa fa-copy"></i></a></div>
                                            <div class="crediantials-field">{{trans('lang.password')}}:<span id="paassword_field">12345678</span><a href="javascript:void(0)" onclick="copyToClipboard('12345678')"><i class="fa fa-copy"></i></a></p></div>
                                         </div>
