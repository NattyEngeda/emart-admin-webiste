...
$(document).ready(function () {
    ...
    ref.get().then(async function (snapshots) {
        ...
        photo = (menuItems.image != '' && menuItems.image != null) ? menuItems.image : placeholderImage;

        $(".destination_image").append('<img class="rounded" style="width:50px" src="' + photo + '" alt="image">');
