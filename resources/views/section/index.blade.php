      ...
      <div class="col-12">
        ...
        <div class="card">
            ...
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
              <li class="nav-item">
                <a class="nav-link active" href="{!! url()->current() !!}"><i
                    class="fa fa-list mr-2"></i>{{trans('lang.section_table')}}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link section-create" href="#"><i
                    class="fa fa-plus mr-2"></i>{{trans('lang.section_create')}}</a>
              </li>
            </ul>
          </div>
          ...
          <div class="table-responsive m-t-10">
            ...
            <table id="example24"
              class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0"
              width="100%">
