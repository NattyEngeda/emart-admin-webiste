            ...
            if(ext == "jpg" || ext == "jpeg" || ext == "png" || ext == "gif" || ext == "zip" || ext == "pdf"){
                ...
                uploadTask.on('state_changed', function (snapshot) {
                    ...
                    uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                        ...
                        setTimeout(function(){
                            $("#uploding_zip").html('<span class="image-item zip-file"><span class="delete-btn delete-zip" data-file="'+downloadURL+'"><i class="fa fa-remove"></i></span><i class="fa fa-file-text" style="font-size:45px;"></i></span>');
                        },3000);
