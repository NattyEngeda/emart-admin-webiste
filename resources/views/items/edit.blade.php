        ...
        <div class="card-body">
            ...
            <div class="row vendor_payout_create">
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset class="section_hide" style="display: none;">
            ...
            <div class="form-group col-12 text-center btm-btn">
                <button type="button" class="btn btn-primary  save_item_btn"><i
    ...
    ref.get().then(async function (snapshots) {
        ...
        if (product.hasOwnProperty("isDigitalProduct") && product.hasOwnProperty("digitalProduct")) {
            ...
            if (product.digitalProduct) {
                $("#uploding_zip").html('<span class="image-item zip-file mt-2"><span class="delete-btn delete-zip" data-itemid="'+product.id+'" data-file="'+product.digitalProduct+'"><i class="fa fa-remove"></i></span><i class="fa fa-file-text" style="font-size:45px;"></i></span>');
            ...
            if(ext == "jpg" || ext == "jpeg" || ext == "png" || ext == "gif" || ext == "zip" || ext == "pdf"){
                ...
                uploadTask.on('state_changed', function (snapshot) {
                    ...
                    uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                        ...
                        setTimeout(function(){
                            $("#uploding_zip").html('<span class="image-item zip-file"><span class="delete-btn delete-zip" data-itemid="'+id+'"  data-file="'+downloadURL+'"><i class="fa fa-remove"></i></span><i class="fa fa-file-text" style="font-size:45px;"></i></span>');;
                        },2000);
