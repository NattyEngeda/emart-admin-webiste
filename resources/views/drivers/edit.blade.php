            ...
            <div class="card-body">
                ...
                <div class="row daes-top-sec mb-3">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('vendors.orders','driverId='.$id)}}">
                        ...
                        <fieldset>
                            ...
                            <div class="cab_service" style="display: none">
                                ...
                                <div class="form-group row width-50 individualDiv">
                                    ...
                                    <div class="col-12">
                                        <select name="cab_section_id" id="cab_section_id" class="form-control cab_section_id">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row width-50 individualDiv">
                                ...
                                <div class="form-group row width-50 chooseRideType">
                                    ...
                                    <div class="col-7">
                                        <input type="checkbox" class="col-7 form-check-inline" id="is_ride" checked disabled>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <label class="control-label" for="is_intercity">{{trans('lang.intercity')}}</label>
                                    </div>
                                </div>
